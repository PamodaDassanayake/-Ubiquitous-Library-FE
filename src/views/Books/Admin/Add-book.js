        ...
        return (
            <>
                ...
                <Form labelCol={{span: 6}}
                    ...
                    <Form.Item fieldKey='name' name={['book', 'name']} label="Book name" rules={[{type: 'string', required: true}]}>
                        <Input onChange={this.getBookName}/>
                    </Form.Item>
                    <Form.Item fieldKey='author' name={['book', 'author']} label="Author" rules={[{type: 'string', required: true}]}>
                        <Input/>
                    </Form.Item>
                    ...
                    <Form.Item fieldKey='isbn' name={['book', 'isbn']} label="ISBN" rules={[{type: 'string', required: true}]}>
                        <Input/>
                    </Form.Item>
                    <Form.Item fieldKey='edition' name={['book', 'edition']} label="Edition" rules={[{type: 'number', min: 1}]}>
                        <InputNumber/>
                    </Form.Item>
                    <Form.Item fieldKey='Year' name={['book', 'year']} label="Year" rules={[{type: 'number', min: 0, max: 2021}]}>
                        <InputNumber/>
                    </Form.Item>
                    ...
                    {formSubmitted && this.props.bookSubmitSuccess && message.success('New Book has added successfully!')}
